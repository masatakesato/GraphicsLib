...
/////
///////////////////////////////// CALCULATE FRUSTUM \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
void ViewFrustum::CalculateFrustum(const Mat4f &matViewProj)
{
	// Now we actually want to get the sides of the frustum.  To do this we take
	// the clipping planes we received above and extract the sides from them.

	// This will extract the RIGHT side of the frustum
	m_Frustum[RIGHT][A] = matViewProj.m30 - matViewProj.m00;//clip[ 3] - clip[ 0];
	m_Frustum[RIGHT][B] = matViewProj.m31 - matViewProj.m01;//clip[ 7] - clip[ 4];
	m_Frustum[RIGHT][C] = matViewProj.m32 - matViewProj.m02;//clip[11] - clip[ 8];
	m_Frustum[RIGHT][D] = matViewProj.m33 - matViewProj.m03;//clip[15] - clip[12];
	...
	m_Frustum[LEFT][A] = matViewProj.m30 + matViewProj.m00;//clip[ 3] + clip[ 0];
	m_Frustum[LEFT][B] = matViewProj.m31 + matViewProj.m01;//clip[ 7] + clip[ 4];
	m_Frustum[LEFT][C] = matViewProj.m32 + matViewProj.m02;//clip[11] + clip[ 8];
	m_Frustum[LEFT][D] = matViewProj.m33 + matViewProj.m03;//clip[15] + clip[12];

	// Normalize the LEFT side
	NormalizePlane(m_Frustum, LEFT);

	// This will extract the BOTTOM side of the frustum
	m_Frustum[BOTTOM][A] = matViewProj.m30 + matViewProj.m10;//clip[ 3] + clip[ 1];
	m_Frustum[BOTTOM][B] = matViewProj.m31 + matViewProj.m11;//clip[ 7] + clip[ 5];
	m_Frustum[BOTTOM][C] = matViewProj.m32 + matViewProj.m12;//clip[11] + clip[ 9];
	m_Frustum[BOTTOM][D] = matViewProj.m33 + matViewProj.m13;//clip[15] + clip[13];

	// Normalize the BOTTOM side
	NormalizePlane(m_Frustum, BOTTOM);

	// This will extract the TOP side of the frustum
	m_Frustum[TOP][A] = matViewProj.m30 - matViewProj.m10;//clip[ 3] - clip[ 1];
	m_Frustum[TOP][B] = matViewProj.m31 - matViewProj.m11;//clip[ 7] - clip[ 5];
	m_Frustum[TOP][C] = matViewProj.m32 - matViewProj.m12;//clip[11] - clip[ 9];
	m_Frustum[TOP][D] = matViewProj.m33 - matViewProj.m13;//clip[15] - clip[13];

	// Normalize the TOP side
	NormalizePlane(m_Frustum, TOP);

	// This will extract the BACK side of the frustum
	m_Frustum[BACK][A] = matViewProj.m30 - matViewProj.m20;//clip[ 3] - clip[ 2];
	m_Frustum[BACK][B] = matViewProj.m31 - matViewProj.m21;//clip[ 7] - clip[ 6];
	m_Frustum[BACK][C] = matViewProj.m32 - matViewProj.m22;//clip[11] - clip[10];
	m_Frustum[BACK][D] = matViewProj.m33 - matViewProj.m23;//clip[15] - clip[14];

	// Normalize the BACK side
	NormalizePlane(m_Frustum, BACK);

	// This will extract the FRONT side of the frustum
	m_Frustum[FRONT][A] = matViewProj.m30 + matViewProj.m20;//clip[ 3] + clip[ 2];
	m_Frustum[FRONT][B] = matViewProj.m31 + matViewProj.m21;//clip[ 7] + clip[ 6];
	m_Frustum[FRONT][C] = matViewProj.m32 + matViewProj.m22;//clip[11] + clip[10];
	m_Frustum[FRONT][D] = matViewProj.m33 + matViewProj.m23;//clip[15] + clip[14];
...
bool ViewFrustum::PointInFrustum( float x, float y, float z )
{
...
bool ViewFrustum::CubeInFrustum( float x, float y, float z, float size )
{
