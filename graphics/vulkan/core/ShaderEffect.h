...
namespace vk
{
	...
	public:
		...
		uint32_t NumSets( uint32 pass ) const	{ return m_DescriptorBuffers[ pass ].NumSets<uint32_t>(); }
	...
	private:
		...
		OreOreLib::Array<DescriptorBuffer>			m_DescriptorBuffers;// 各サブパスのDescritorSet.
	};
