...
WorleyNoiseGPU::WorleyNoiseGPU()
{
	...
	m_Mode						= 0;	// Cell Noise Mode for Default
}
...
void WorleyNoiseGPU::InitShader( const TCHAR *filepath, GLSL_VERSION version )
{
	...
	m_ulPermTexture	= glGetUniformLocation( m_pShader->ID(), "g_WorleyPermTexture" );
	...
	m_ulMode		= glGetUniformLocation( m_pShader->ID(), "g_Mode" );
...
void WorleyNoiseGPU::InitPermTexture()
{
	...
	//m_PermTexture.Allocate( 256, 0, 0, FORMAT_R8_UINT );
	...
	m_PermTexture.Allocate( 256, 0, 0, FORMAT_R8_UINT, perm );
