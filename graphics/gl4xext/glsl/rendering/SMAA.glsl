...
// */
//float2 SMAASearchDiag1(SMAATexture2D(edgesTex), float2 texcoord, float2 dir, inout float2 e) {
...
//}
//
//float2 SMAASearchDiag2(SMAATexture2D(edgesTex), float2 texcoord, float2 dir, inout float2 e) {
//    float4 coord = float4(texcoord, -1.0, 1.0);
