...
# Mouse event https://docs.microsoft.com/en-us/windows/win32/api/winuser/ns-winuser-mouseinput
...
# KEYBDINPUT https://docs.microsoft.com/ja-jp/windows/win32/api/winuser/ns-winuser-keybdinput
