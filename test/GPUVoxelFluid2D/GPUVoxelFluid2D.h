#ifndef	GPU_VOXEL_FLUID_2D_H
#define GPU_VOXEL_FLUID_2D_H
...
namespace OreOreLib
{
	...
	public:
		...
		void BindVoxelData( FluidVoxelData2D *pVoxelData );
...
FLUID_PASS_VORTICITY_CONFINEMENT,
		...
		FluidVoxelData2D	*m_refFluidVoxelData;
